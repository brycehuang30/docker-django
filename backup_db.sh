...
# Template:
# sudo docker run --rm -v <volume_name>:/dbdata -v $(pwd):/backup ubuntu:latest bash -c "cd /dbdata && tar xvf /backup/<backup_filename> --strip 1"
#
# Example:
# sudo docker run --rm -v docker-django_postgres_data:/dbdata -v $(pwd):/backup postgres:12.0-alpine bash -c "cd /dbdata && tar xvf /backup/backup.2020-08-20_03\:08\:06.tar --strip 1"